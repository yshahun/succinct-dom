...
/**
 * A succinct {@link Comment} node. Internal {@code ordinalIndex} is treated as the index of the
 * node among all the non-text nodes.
 *
...
public class CommentImpl extends AbstractCharacterData implements Comment {
  ...
  /**
   * Constructs a succinct comment node.
   *
   ...
   */
  public CommentImpl(SuccinctDom dom, int index, int ordinalIndex) {
